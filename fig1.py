...
#
#This program is a Python script that reproduces Figures 3 through 9 from the paper "A dynamic model of subjectivity integrating emotional gain, internal bias, and self-regulation".
#
